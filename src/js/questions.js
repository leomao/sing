...
曾任鼓吹自由民權運動的報刊{何報刊:東洋自由新聞}的社長。',
    ...
    {
        question: '尾崎行雄有{哪兩個稱號:憲政之神、議會政治之父}的美稱。',
        level: 3,
    },
    {
...
，曾任{何學校:東京帝大}總長。',
    ...
    {
        question: '吉野造作曾應{誰:袁世凱}之聘赴天津，擔任{誰:克定}之家教，並任教於{何學校:法政專門學堂}。',
        level: 3,
    },
    {
        question: '大正 5 年，吉野造作在雜誌{何雜誌:中央公論}發表長文{何著作:談憲政的本義\
(兼論遂其有終之美的方法)}。',
        level: 3,
    },
    {
...
內閣執意干涉{何事件:俄國革命}出兵{何處:西伯利亞}。其內閣垮臺後由{誰:原敬}組閣。',
    ...
    {
        question: '吉野在大正 7 年組成了{何團體:黎明會}，主張普通選舉，翌年出版了{何著作:普通選舉論}。',
        level: 3,
    },
    {
...
。該會後編纂了{何著作:明治文化全集}。',
    ...
    {
        question: '吉野作造紀念館是由其女婿{誰:齋藤素嚴}製作。',
        level: 3,
    },
    {
...
居住之世界為{何處:豐葦原瑞穗國(中國)}，死後的世界稱為{何處:根之堅州國或黃泉國。',
    ...
    {
        question: '古代日本神話中，眾神命{誰:伊邪那岐命}和{誰:伊邪那美命}將漂流在海上的\
大地固定。',
        level: 3,
    },
    {
...
{何神:須佐之男命}。',
    ...
    {
        question: '{誰:須佐之男命}引發了天之岩屋事件，後被眾神逐出高天原，到出雲\
斬八岐大蛇後娶了{誰:櫛名田姬}為妻。',
        level: 3,
    },
    {
        question: '出雲大社為供奉{誰:須佐之男命}的第 6 代子孫{誰:大國主命}之所在，\
其後聽從了{誰:天照大神}的神敕，將國土讓給了{誰:瓊瓊杵尊}。',
        level: 3,
    },
    {
...
宇喜多秀家、上杉景勝}。在關原會戰時，其長子{誰:利長}屬東軍，次子{誰:利政}屬西軍。',
    ...
    {
        question: '前田家的家徽為{什麼:梅鉢}，德川家的家徽為{圓中三葉葵}。\
日本政府的代表性紋章為{什麼:五七桐花紋}，天皇家的家紋為{什麼:十六八重表菊}。',
        level: 3,
    },
    {
        question: '東京大學的象徵之一赤門為誰{齊泰}為迎娶{誰:家齊}的第 21 女{誰:溶姬}所建。',
        level: 3,
    },
    {
        question: '八田與一的恩師為{誰:廣井勇}，有{何美稱:日本港灣工程學之父}的美譽\
曾負責{哪兩個港:函館、小樽築港}的工程。',
        level: 3,
    },
    {
...
後來又完成了烏山頭水庫和嘉南大圳的設計，並獲得{誰:田健治郎}總督的支持。',
    ...
    {
        question: '第 7 任臺灣總督為{誰:明石元二郎}，當時的總務長官為{官下村宏}。',
        level: 3,
    },
    {
...
將這 100 俵變賣成立國漢學校，最後該校培育出東京帝大總長{誰:小野塚喜平次}、解剖學者{誰:小金井良精}\
和{誰:三本五十六}。',
        level: 3,
    },
    {
...
作戰參謀謀為{誰:秋山真之}。而山本五十六搭乘的艦為{哪艘艦:日進號}。',
        level: 3,
    },
    {
...
而三笠號為{何類:戰艦}。',
    ...
    {
        question: '山本五十六在昌昭和 3 年返國後，出任輕巡{哪艘艦:五十領}和航母{哪艘艦:赤城}的艦長。',
        level: 3,
    },
    {
...
一等、二等驅逐艦則分別以{什麼:天候、氣象}和{什麼:樹木、花草}命名。',
    ...
    {
        question: '昭和 12 年山本出任海軍大臣{誰:米內先政}的海軍次官，兩人和{誰:井上成美}\
...
登上鈔票的是{誰:紫式部}，戰後第一個登上鈔票肖像的是{誰:樋口一葉}。',
    ...
    {
        question: '日本陸軍史上最大的叛亂事件是{何事件:二二六事件}。',
        level: 3,
    },
    {
