...
的第一任局長{誰:長與專齋}提拔。翌年和{誰:安場}的次女{誰:和子}結婚',
        level: 3,
    },
    {
...
後來更把經驗移稙到{何處:關東州}，成立{何機構:滿鐵調查部}。',
    ...
    {
        question: '後藤主張效法英國的{何主義:特別統治主義}，而當時的{誰:原敬}則主張\
仿效法國的{何主義:內地延長主義}',
        level: 3,
    },
    {
...
曾在院內創辦講習所。',
    ...
    {
        question: '後藤曾聘請{誰:長谷川謹介}完成縱貫鐵路、又命{誰:長尾半平}擔任\
...
在他死後其遺志由{誰:濱野彌四郎}繼承，而{誰:八田與一}又曾是前者的部屬。',
    ...
    {
        question: '後藤成立{何機構:臨時臺灣土地調查局}以確定土地的所有權，\
以{誰:中村是公}為次長。後來又成立{何機構:臨時臺灣基隆築港局}進行基隆築港工程，\
